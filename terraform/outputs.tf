...
output "oci_instance_1_public_ip" {
  value = oci_core_instance.homelab_dev_vm_1.public_ip
}

output "oci_instance_2_public_ip" {
  value = oci_core_instance.homelab_dev_vm_2.public_ip
}
